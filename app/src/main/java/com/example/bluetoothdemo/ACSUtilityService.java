...
public class ACSUtilityService extends Service {
    ...
    public  final static UUID ACS_SERVICE_UUID = UUID.fromString("0000FE59-0000-1000-8000-00805f9b34fb");
	private  final UUID CMD_LINE_UUID = UUID.fromString("8ec90003-f315-4f60-9fb8-838830daea50");
	private  final UUID DATA_LINE_UUID = UUID.fromString("8ec90002-f315-4f60-9fb8-838830daea50");
